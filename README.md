...
> **OpenRouter port** — this repo runs on [OpenRouter](https://openrouter.ai) instead of the OpenAI API directly. See [README_OPENROUTER.md](./README_OPENROUTER.md) for the required env vars and model setup before following the instructions below.
